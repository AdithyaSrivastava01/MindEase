  ...
  useEffect(() => {
    ...
    const loadJournalData = () => {
      ...
      if (journalEntries) {
        ...
        // Get last 7 entries and reverse to show oldest to newest
        ...
        }).reverse(); // Reverse so chart shows chronologically
    ...
    // Reload when localStorage changes (when new journal entry is added)
